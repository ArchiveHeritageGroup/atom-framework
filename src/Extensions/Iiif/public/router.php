...
// Bootstrap - path from /src/Extensions/Iiif/public/ to /bootstrap.php
require_once dirname(__DIR__, 4) . '/bootstrap.php';

// Include services and controllers directly (not using autoloader)
$extDir = dirname(__DIR__);
require_once $extDir . '/Services/IiifManifestService.php';
require_once $extDir . '/Services/AnnotationService.php';
require_once $extDir . '/Services/OcrService.php';
require_once $extDir . '/Services/ViewerService.php';
require_once $extDir . '/Services/MediaMetadataService.php';
require_once $extDir . '/Services/TranscriptionService.php';
require_once $extDir . '/Services/SnippetService.php';
require_once $extDir . '/Controllers/IiifController.php';
require_once $extDir . '/Controllers/MediaController.php';
