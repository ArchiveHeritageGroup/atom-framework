 ...
 */
class StandaloneDonorWriteService implements DonorWriteServiceInterface
{
    ...
    public function createDonor(array $data, string $culture = 'en'): int
    {
        ...
        // Use transaction for the 4-table insert: object -> actor -> actor_i18n -> donor
        $objectId = DB::transaction(function () use ($core, $i18n, $culture) {
            ...
            DB::table('donor')->insert(['id' => $objectId]);
    ...
    public function newDonor(): object
    {
        $donor = new \stdClass();
        $donor->id = null;
        $donor->authorizedFormOfName = null;
        $donor->parentId = \QubitActor::ROOT_ID;
