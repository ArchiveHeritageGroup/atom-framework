...
CREATE TABLE IF NOT EXISTS `access_request` (
  ...
  `scope_type` VARCHAR(61) COMMENT 'single, with_children, collection, repository_all' DEFAULT 'single',
...
CREATE TABLE IF NOT EXISTS `agreement_rights_vocabulary` (
  ...
  `category` VARCHAR(50) COMMENT 'usage, restriction, condition, license' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ahg_settings` (
  ...
  `setting_type` VARCHAR(49) COMMENT 'string, integer, boolean, json, float' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'string',
...
CREATE TABLE IF NOT EXISTS `ahg_vendor_transaction_attachments` (
  ...
  `attachment_type` VARCHAR(80) COMMENT 'quote, invoice, condition_report, photo, receipt, certificate, other' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ahg_vendor_transaction_items` (
  ...
  `condition_before_rating` VARCHAR(49) COMMENT 'excellent, good, fair, poor, critical' COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `condition_after` text COLLATE utf8mb4_unicode_ci,
  `condition_after_rating` VARCHAR(49) COMMENT 'excellent, good, fair, poor, critical' COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ahg_vendor_transactions` (
  ...
  `vendor_id` int NOT NULL,
  `service_type_id` int NOT NULL,
  `status` VARCHAR(137) COMMENT 'pending_approval, approved, dispatched, received_by_vendor, in_progress, completed, ready_for_collection, returned, cancelled' COLLATE utf8mb4_unicode_ci DEFAULT 'pending_approval',
  ...
  `payment_status` VARCHAR(50) COMMENT 'not_invoiced, invoiced, paid, disputed' COLLATE utf8mb4_unicode_ci DEFAULT 'not_invoiced',
...
CREATE TABLE IF NOT EXISTS `ahg_vendors` (
  ...
  `vendor_type` VARCHAR(56) COMMENT 'company, individual, institution, government' COLLATE utf8mb4_unicode_ci DEFAULT 'company',
  ...
  `status` VARCHAR(57) COMMENT 'active, inactive, suspended, pending_approval' COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `approved_by` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `atom_extension` (
  ...
  `status` VARCHAR(57) COMMENT 'installed, enabled, disabled, pending_removal' COLLATE utf8mb4_unicode_ci DEFAULT 'installed',
  `protection_level` VARCHAR(42) COMMENT 'core, system, theme, extension' COLLATE utf8mb4_unicode_ci DEFAULT 'extension',
...
CREATE TABLE IF NOT EXISTS `atom_extension_audit` (
  ...
  `action` VARCHAR(157) COMMENT 'discovered, installed, enabled, disabled, uninstalled, upgraded, downgraded, backup_created, backup_restored, data_deleted, config_changed, error' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `atom_extension_menu` (
  ...
  `menu_location` VARCHAR(45) COMMENT 'main, admin, user, footer, mobile' COLLATE utf8mb4_unicode_ci DEFAULT 'main',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `atom_extension_pending_deletion` (
  ...
  `status` VARCHAR(69) COMMENT 'pending, processing, deleted, restored, cancelled, failed' COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `atom_extension_setting` (
  ...
  `setting_type` VARCHAR(49) COMMENT 'string, integer, boolean, json, array' COLLATE utf8mb4_unicode_ci DEFAULT 'string',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `atom_extension_widget` (
  ...
  `widget_type` VARCHAR(55) COMMENT 'stat_card, chart, list, table, html, custom' COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `atom_isbn_provider` (
  ...
  `response_format` VARCHAR(30) COMMENT 'json, xml, marcxml' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'json',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `atom_landing_block` (
  ...
  `container_type` VARCHAR(42) COMMENT 'fluid, container, container-lg' COLLATE utf8mb4_unicode_ci DEFAULT 'container',
...
CREATE TABLE IF NOT EXISTS `atom_landing_page_version` (
  ...
  `status` VARCHAR(38) COMMENT 'draft, published, archived' COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS `atom_plugin` (
  ...
  `status` VARCHAR(57) COMMENT 'installed, enabled, disabled, pending_removal' DEFAULT 'enabled',
...
CREATE TABLE IF NOT EXISTS `contact_information_extended` (
  ...
  `preferred_contact_method` VARCHAR(41) COMMENT 'email, phone, cell, fax, mail' COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `digital_object_faces` (
  ...
  `identification_source` VARCHAR(34) COMMENT 'auto, manual, verified' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `digital_object_metadata` (
  `id` int NOT NULL AUTO_INCREMENT,
  `digital_object_id` int NOT NULL,
  `file_type` VARCHAR(51) COMMENT 'image, pdf, office, video, audio, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `email_setting` (
  ...
  `setting_key` varchar(100) NOT NULL,
  `setting_value` text,
  `setting_type` VARCHAR(60) COMMENT 'text, email, number, boolean, textarea, password' DEFAULT 'text',
...
CREATE TABLE IF NOT EXISTS `gallery_exhibition` (
  ...
  `description` text,
  `curator` varchar(255) DEFAULT NULL,
  `exhibition_type` VARCHAR(60) COMMENT 'permanent, temporary, traveling, virtual, pop-up' DEFAULT 'temporary',
  `status` VARCHAR(77) COMMENT 'planning, confirmed, installing, open, closing, closed, cancelled' DEFAULT 'planning',
...
CREATE TABLE IF NOT EXISTS `gallery_exhibition_checklist` (
  ...
  `description` text,
  `category` VARCHAR(82) COMMENT 'planning, design, marketing, installation, opening, operation, closing' DEFAULT 'planning',
  `assigned_to` varchar(255) DEFAULT NULL,
  `due_date` date DEFAULT NULL,
  `completed_at` datetime DEFAULT NULL,
  `completed_by` int DEFAULT NULL,
  `priority` VARCHAR(39) COMMENT 'low, medium, high, critical' DEFAULT 'medium',
...
CREATE TABLE IF NOT EXISTS `getty_vocabulary_link` (
  ...
  `vocabulary` VARCHAR(26) COMMENT 'aat, tgn, ulan' NOT NULL,
  `getty_uri` varchar(255) NOT NULL,
  `getty_id` varchar(50) NOT NULL,
  `getty_pref_label` varchar(500) DEFAULT NULL,
  `getty_scope_note` text,
  `status` VARCHAR(51) COMMENT 'confirmed, suggested, rejected, pending' NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `information_object_physical_location` (
  ...
  `condition_status` VARCHAR(49) COMMENT 'excellent, good, fair, poor, critical' DEFAULT NULL,
  `condition_notes` text,
  `access_status` VARCHAR(59) COMMENT 'available, in_use, restricted, offsite, missing' DEFAULT 'available',
...
CREATE TABLE IF NOT EXISTS `loan` (
  ...
  `loan_type` VARCHAR(20) COMMENT 'out, in' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `purpose` VARCHAR(97) COMMENT 'exhibition, research, conservation, photography, education, filming, long_term, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'exhibition',
  ...
  `insurance_type` VARCHAR(54) COMMENT 'borrower, lender, shared, government, self' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'borrower',
...
CREATE TABLE IF NOT EXISTS `loan_document` (
  ...
  `document_type` VARCHAR(125) COMMENT 'agreement, facilities_report, condition_report, insurance_certificate, receipt, correspondence, photograph, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `media_derivatives` (
  `id` int NOT NULL AUTO_INCREMENT,
  `digital_object_id` int NOT NULL,
  `derivative_type` VARCHAR(48) COMMENT 'thumbnail, poster, preview, waveform' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `media_metadata` (
  ...
  `digital_object_id` int NOT NULL,
  `object_id` int DEFAULT NULL,
  `media_type` VARCHAR(24) COMMENT 'audio, video' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `media_processing_queue` (
  ...
  `digital_object_id` int NOT NULL,
  `object_id` int NOT NULL,
  `task_type` VARCHAR(67) COMMENT 'metadata_extraction, transcription, waveform, thumbnail' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `task_options` json DEFAULT NULL,
  `status` VARCHAR(50) COMMENT 'pending, processing, completed, failed' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `priority` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `media_processor_settings` (
  ...
  `setting_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `setting_value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `setting_type` VARCHAR(49) COMMENT 'string, integer, float, boolean, json' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'string',
...
CREATE TABLE IF NOT EXISTS `metadata_extraction_log` (
  ...
  `file_size` int DEFAULT NULL,
  `operation` VARCHAR(62) COMMENT 'extract, face_detect, face_match, index_face, bulk' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` VARCHAR(45) COMMENT 'success, partial, failed, skipped' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `metadata_extracted` tinyint(1) DEFAULT '0',
  `faces_detected` int DEFAULT '0',
  `faces_matched` int DEFAULT '0',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `processing_time_ms` int DEFAULT NULL,
  `triggered_by` VARCHAR(36) COMMENT 'upload, job, manual, api' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `oais_fixity_check` (
  ...
  `check_type` VARCHAR(31) COMMENT 'md5, sha256, sha512' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oais_information_package` (
  ...
  `status` VARCHAR(70) COMMENT 'pending, ingesting, stored, preserved, disseminated, error' DEFAULT 'pending',
  ...
  `preservation_level` VARCHAR(34) COMMENT 'bit, logical, semantic' DEFAULT 'bit',
...
CREATE TABLE IF NOT EXISTS `oais_package_content` (
  ...
  `content_type` VARCHAR(50) COMMENT 'content, metadata, manifest, signature' DEFAULT 'content',
...
CREATE TABLE IF NOT EXISTS `oais_premis_event` (
  ...
  `event_type` VARCHAR(289) COMMENT 'capture, compression, creation, deaccession, decompression, decryption, deletion, digital_signature_validation, dissemination, encryption, fixity_check, format_identification, ingestion, message_digest_calculation, migration, normalization, replication, validation, virus_check' NOT NULL,
  `event_date_time` datetime NOT NULL,
  `event_detail` text,
  `event_outcome` VARCHAR(37) COMMENT 'success, failure, warning' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oais_preservation_policy` (
  ...
  `action_type` VARCHAR(49) COMMENT 'migrate, normalize, emulate, preserve' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `object_access_grant` (
  ...
  `object_id` int unsigned NOT NULL,
  `include_descendants` tinyint(1) DEFAULT '0',
  `access_level` VARCHAR(32) COMMENT 'view, download, edit' DEFAULT 'view',
...
CREATE TABLE IF NOT EXISTS `physical_object_extended` (
  ...
  `status` VARCHAR(53) COMMENT 'active, full, maintenance, decommissioned' DEFAULT 'active',
  `notes` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `provenance_entry` (
  ...
  `owner_type` VARCHAR(108) COMMENT 'person, family, dealer, auction_house, museum, corporate, government, religious, artist, unknown' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  ...
  `start_date_qualifier` VARCHAR(36) COMMENT 'circa, before, after, by' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `end_date` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `end_date_qualifier` VARCHAR(36) COMMENT 'circa, before, after, by' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transfer_type` VARCHAR(138) COMMENT 'sale, auction, gift, bequest, inheritance, commission, exchange, seizure, restitution, transfer, loan, found, created, unknown' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  ...
  `certainty` VARCHAR(59) COMMENT 'certain, probable, possible, uncertain, unknown' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
...
CREATE TABLE IF NOT EXISTS `report_definition` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `category` VARCHAR(101) COMMENT 'collection, acquisition, access, preservation, researcher, compliance, statistics, custom' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `research_annotation` (
  ...
  `object_id` int NOT NULL,
  `digital_object_id` int DEFAULT NULL,
  `annotation_type` VARCHAR(57) COMMENT 'note, highlight, bookmark, tag, transcription' DEFAULT 'note',
  `title` varchar(255) DEFAULT NULL,
  `content` text,
...
CREATE TABLE IF NOT EXISTS `research_researcher` (
  ...
  `status` VARCHAR(49) COMMENT 'pending, approved, suspended, expired' DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `research_saved_search` (
  ...
  `alert_frequency` VARCHAR(34) COMMENT 'daily, weekly, monthly' DEFAULT 'weekly',
...
CREATE TABLE IF NOT EXISTS `saved_search` (
  ...
  `notification_frequency` VARCHAR(34) COMMENT 'daily, weekly, monthly' COLLATE utf8mb4_unicode_ci DEFAULT 'weekly',
...
CREATE TABLE IF NOT EXISTS `tiff_pdf_merge_file` (
  ...
  `status` VARCHAR(51) COMMENT 'uploaded, processing, processed, failed' COLLATE utf8mb4_unicode_ci DEFAULT 'uploaded',
  `error_message` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `tiff_pdf_merge_job` (
  ...
  `status` VARCHAR(58) COMMENT 'pending, queued, processing, completed, failed' COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  ...
  `pdf_standard` VARCHAR(42) COMMENT 'pdf, pdfa-1b, pdfa-2b, pdfa-3b' COLLATE utf8mb4_unicode_ci DEFAULT 'pdfa-2b',
  `compression_quality` int DEFAULT '85',
  `page_size` VARCHAR(39) COMMENT 'auto, a4, letter, legal, a3' COLLATE utf8mb4_unicode_ci DEFAULT 'auto',
  `orientation` VARCHAR(37) COMMENT 'auto, portrait, landscape' COLLATE utf8mb4_unicode_ci DEFAULT 'auto',
  `dpi` int DEFAULT '300',
...
CREATE TABLE IF NOT EXISTS `tiff_pdf_settings` (
  ...
  `setting_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `setting_value` text COLLATE utf8mb4_unicode_ci,
  `setting_type` VARCHAR(42) COMMENT 'string, integer, boolean, json' COLLATE utf8mb4_unicode_ci DEFAULT 'string',
  `description` text COLLATE utf8mb4_unicode_ci,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `setting_key` (`setting_key`)
