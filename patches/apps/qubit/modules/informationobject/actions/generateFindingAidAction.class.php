...
class InformationObjectGenerateFindingAidAction extends sfAction
{
    public function execute($request)
    {
        ...
        // SECURITY: generating a finding aid queues a job and writes a file for
        // this description. Require update authorization on the object (this
        // action was previously reachable unauthenticated).
