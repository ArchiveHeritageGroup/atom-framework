...
class QubitXmlImport
{
    ...
    protected function loadXML($xmlFile, $options = [])
    {
        ...
        if ($strictXmlParsing) {
            ...
            // SECURITY (XXE): never resolve external DTDs/entities from uploaded XML.
        ...
        // SECURITY (XXE): do not substitute custom/external entities declared in the
        // uploaded document. Blocks file:// disclosure, http:// SSRF and entity-
        // expansion (billion laughs) DoS via a malicious <!DOCTYPE ... <!ENTITY>>.
        $doc->substituteEntities = false;

        // SECURITY (XXE): LIBXML_NONET forbids any network access during parsing.
