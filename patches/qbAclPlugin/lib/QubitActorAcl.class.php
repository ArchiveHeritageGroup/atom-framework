...
class QubitActorAcl extends QubitAcl
{
    ...
    private static function isDigitalObjectActionAllowed(
        ...
        // AHG (#258): same text/PDF master bypass as QubitInformationObjectAcl.
        // Off by default; allow_public_text_masters in ahg_settings restores the
        // upstream behaviour. See artefactual/atom#1724.
    ...
    /**
     * Whether anonymous access to text/PDF masters is permitted. Fails closed.
     */
