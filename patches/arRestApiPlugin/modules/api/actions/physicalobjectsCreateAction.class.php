...
class ApiPhysicalObjectsCreateAction extends QubitApiAction
{
    ...
    {
        // SECURITY: creating a physical object (and minting taxonomy terms via
        // processField) is an editor operation. Reject authenticated identities
        // that do not hold the editor credential (was: any authenticated user).
